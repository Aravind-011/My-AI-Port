...
// Using remote images provided by the user for exact visual parity
import boeing from "../images/boeing.jpg";
import ull from "../images/ull.webp";
...
export const Bio = {
  ...
  resume:
    "/Aravind_Osuri_Resume.pdf",
  linkedin: "https://www.linkedin.com/in/kumar-avinath1702/",
};
...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "HTML",
        image: "https://adarshvodnala.vercel.app/images/html.webp",
      },
      {
        name: "CSS",
        image: "https://adarshvodnala.vercel.app/images/css.webp",
      },
      {
        name: "Bootstrap",
        image: "https://adarshvodnala.vercel.app/images/bootstrap.webp",
      },
      {
        name: "Tailwind",
        image: "https://adarshvodnala.vercel.app/images/tailwind.webp",
      },
    ],
  },
  {
...

  {
    ...
    skills: [
      ...
      {
        name: "Docker",
        image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRS07f6A9NY_5K5Ie-s-P4M1ErApMYC_t9fg&s",
      },
      {
        name: "VS Code",
        image:
  ...
  },
  {
    ...
    {
      name:"ExpressJS",
      image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr3Sp_9UnvsXgAfScS9AHtLrnKfSkAo5RLmw&s",
    },
    {
       name:"MogoDb",
...
export const testimonials = [
  {
    ...
    description: "Aravind is an exceptional developer with outstanding problem-solving skills. His contribution to our projects has been invaluable, and his code quality is consistently high.",
  ...
  },
  {
    ...
    description: "Working with Aravind was a great experience. He's responsive, detail-oriented, and always goes the extra mile. Highly recommend!",
    image: "https://via.placeholder.com/100?text=Sarah+Johnson",
  ...
  },
  {
    ...
    description: "Aravind demonstrates strong technical expertise and excellent communication skills. A true asset to any development team.",
    image: "https://via.placeholder.com/100?text=Mike+Wilson",
...
export const experiences = [
  ...
  },
  {
    id: 5,
    img: ull,
    role: "University Of Louisiana at Lafayette ",
    company: "Graduate Research Assistant",
    date: "Jan 2023 - Dec 2023",
    desc: "As a Graduate Research Assistant, I contributed to several impactful projects, including implementing the user interface for a step clock application, where I focused on designing an intuitive and user-friendly interface to enhance user experience. Additionally, I assisted in Python-based machine learning projects, handling tasks such as data preprocessing, feature selection, and model development. I was also involved in managing and optimizing databases, ensuring data integrity, and facilitating seamless integration between machine learning algorithms and the underlying database.",
  },
  {
    id: 5,
    img: hcl,
...
export const education = [
  {
    ...
    grade: " 3.7 CGPA",
    desc: "I hold a Master’s degree in Computer Science with a CGPA of 3.7. My academic journey included coursework in foundational and advanced subjects such as Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, among others.",
  ...
  grade: "3.5 CGPA",
  desc: "I hold a Bachelor’s degree in Computer Science, where I built a strong foundation in core computing principles. My coursework covered key subjects such as Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, along with additional topics that strengthened my analytical and problem-solving skills.",
...
export const projects = [
  ...
  },
  {
    ...
    image:
      "https://miro.medium.com/v2/resize:fit:1400/1*IGda1f7np5KIup0lMHBjWg.jpeg",
    tags: [
      "React Js",
      "HTML5",
      "Tailwind CSS",
  ...
  {
    id: 0,
    title: "Student Placement Prediction Using ML",
    description:
...
export const certificates = [
  {
    ...
    description: "Azure certification demonstrating expertise in cloud technologies and solutions.",
    link: "https://learn.microsoft.com/api/credentials/share/en-us/ARAVINDOSURI-1036/A82229474549C6E7?sharingId=7E6347A2B90460F2",
    date: "2024",
    issuer: "Microsoft",
    icon: "🏆"
  },
  {
    id: 1,
    title: "Microsoft Azure Developer Certified",
    description: "Azure Developer certification validating technical expertise in building cloud applications.",
    link: "https://learn.microsoft.com/api/credentials/share/en-us/ARAVINDOSURI-1036/14BA6B776EFE0379?sharingId=7E6347A2B90460F2",
    date: "2024",
    issuer: "Microsoft",
    icon: "🏆"
  }
